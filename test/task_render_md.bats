...
@test "render_task_md renders task header and id" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/01","t":"My task","p":0,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":[],"steps":[]}'
    assert_success
...
@test "render_task_md renders core fields" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/02","t":"Build CLI","p":1,"s":"active","cat":"feat","spec":"task-cli.md","ref":null,"assignee":"a7f2","deps":[],"steps":[]}'
    assert_success
...
@test "render_task_md omits null fields" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/03","t":"Minimal","p":2,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":[],"steps":[]}'
    assert_success
...
@test "render_task_md renders priority 0 (not omitted)" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/04","t":"Critical","p":0,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":[],"steps":[]}'
    assert_success
    assert_output --partial "priority: 0"
}

@test "render_task_md renders deps as comma-separated list" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/05","t":"With deps","p":0,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":["dep/01","dep/02","dep/03"],"steps":[]}'
    assert_success
    assert_output --partial "deps: dep/01, dep/02, dep/03"
}

@test "render_task_md renders single dep without comma" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/06","t":"One dep","p":0,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":["blocker/01"],"steps":[]}'
    assert_success
...
@test "render_task_md renders steps as markdown bullet list" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/07","t":"With steps","p":0,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":[],"steps":["Set up parsing","Add help text","Connect to DB"]}'
    assert_success
...
@test "render_task_md renders all fields together" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"full/01","t":"Full task","p":0,"s":"active","cat":"feat","spec":"test.md","ref":"PR#42","assignee":"a7f2","deps":["dep/01","dep/02"],"steps":["Do thing","Do other thing"]}'
    assert_success
...
@test "render_task_md omits empty deps array" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/08","t":"No deps","p":0,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":[],"steps":[]}'
    assert_success
    refute_output --partial "deps:"
}

@test "render_task_md omits empty steps array" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/09","t":"No steps","p":0,"s":"open","cat":null,"spec":null,"ref":null,"assignee":null,"deps":[],"steps":[]}'
    assert_success
    refute_output --partial "steps:"
}

@test "render_task_md renders ref field when present" {
    run "$SCRIPT_DIR/lib/task" _render-md '{"id":"test/10","t":"Has ref","p":0,"s":"open","cat":null,"spec":null,"ref":"[\"task\",\"test.bats\"]","assignee":null,"deps":[],"steps":[]}'
    assert_success
