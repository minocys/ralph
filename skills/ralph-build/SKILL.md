...
- Your agent identity is available via `$RALPH_AGENT_ID` environment variable, set by ralph.sh before invocation. This ID is used for task claiming and lease tracking.
