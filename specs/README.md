...
| [task-data-store.md](task-data-store.md) | **(Deprecated)** PostgreSQL-backed persistent storage for multi-agent task orchestration — superseded by [sqlite-data-store.md](sqlite-data-store.md) |
...
| [agent-lifecycle.md](agent-lifecycle.md) | Agent registration and identification for concurrent build sessions |
...
| [docker-auto-start.md](docker-auto-start.md) | **(Deprecated)** Automatic PostgreSQL Docker container lifecycle management — superseded by [docker-removal.md](docker-removal.md) |
| [shared-env-config.md](shared-env-config.md) | **(Deprecated)** Single .env file as shared source of truth for database configuration — superseded by [sqlite-data-store.md](sqlite-data-store.md) |
